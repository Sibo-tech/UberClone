...
public class UberRide extends Ride {
    ...
    public void completePayment(Driver driver, Passenger passenger) {
        /**
         * Add money to driver Deduct money from passenger
         */
    ...
    public double MyGETRequest(String startingPoint, String endingPoint) throws IOException {
        URL urlForGetRequest = new URL("https://maps.googleapis.com/maps/api/distancematrix/json?origins="
    ...
    /**
     * converts jsonstring to gson object, then it returns the text length can
     * access elements using: getAsJsonObject getAsJsonArray
     */
    public String retrieveDistanceAsString(String jsonString) {
        ScriptEngineManager builder = new ScriptEngineManager();
        Bindings bindings;
        builder.setBindings(bindings);
        ScriptEngine nashorn = ScriptEngine.ARGV
